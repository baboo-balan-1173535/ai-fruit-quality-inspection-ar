...
The wearable component of [Kiwi Sorter](../README.md): an optical see-through AR
overlay that locks bounding boxes and a quality card onto **real fruit** seen
through XREAL One glasses.
...
snapshot/record). Future: on-device inference, and a custom segmentation model
for clustered fruit + kiwi (see `../Documentation/ML_upgrade_plan.md`).
